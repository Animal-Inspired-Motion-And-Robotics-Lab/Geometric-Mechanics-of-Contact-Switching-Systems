...
% % load('Data\sysf_hybridC_2c1r__shchf_hybridC_Square'); gcirc_large = p.G_locus_full{1,1}.G(:,1:2);
% % 
% % %%
% % % p structure for the smaller displacement stride -- MAKE CHANGES TO THE
% % % SHAPE CHANGE FILE FIRST AND RUN THE NEW PLOT TO CHECK
% % load('Data\sysf_hybridC_2c1r__shchf_hybridC_Square'); gcirc_small = p.G_locus_full{1,1}.G(:,1:2);
% 
...
% load('Data\OptimalYDisplacementSwing_2hybC.mat');
% 
...
% load('Data\sysf_hybridC_3c1r__shchf_hybridC_Square.mat'); gcirc3C_23 = p.G_locus_full{1,1}.G(:,1:2);
% load('Data\sysf_hybridC_3c1r__shchf_hybridC_Square.mat'); gcirc3C_12 = p.G_locus_full{1,1}.G(:,1:2);
% load('Data\sysf_hybridC_3c1r__shchf_hybridC_Square.mat'); gcirc3C_31 = p.G_locus_full{1,1}.G(:,1:2);
% Let's save the data we have locally:
% save('Data\contactPair122331Displacement_3hybC.mat',"gcirc3C_12","gcirc3C_23","gcirc3C_31");
...
% Load the data:
load('Data\contactPair122331Displacement_3hybC.mat');
